...
// MARK: - BandwidthRouter

/// Bandwidth-first routing (Uzu) for Hayabusa cluster.
/// Routes requests to the node with highest effective bandwidth,
/// spilling over from local to remote only when local utilization exceeds threshold.
